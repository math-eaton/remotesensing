...
input_file = 'src/assets/data/internal/temp/FM_service_contour_downsample12_join_20240324.json'  
...
# output info
output_name = f"FM_service_contour_downsample12_FMinfoJoin"
output_path = os.path.join("src/assets/data/internal/temp", output_name)
extension = ".geojson"
